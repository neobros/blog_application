      ...
      <div class="left">
        ...
        <div class="contact">
          <form method="POST" action="/register">
            @csrf
            <h3>SIGN UP</h3>
            <input id="name" type="text" placeholder="Name" class="@error('name') is-invalid @enderror" name="name"
            ...
            <input id="email" type="email" placeholder="Email Address" class=" @error('email') is-invalid @enderror"
            ...
            <a href="/login">
              <ipput type="button" class="submit1">LOG IN</ipput>
            </a>
          </form>
        </div>
      </div>
