    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub  @if(\Request::is('admin/userList'))) active @endif">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  @if(\Request::is('admin/userList'))) active @endif ">
                            <a href="/admin/userList" class="submenu-link">User List</a>
                        </li>

                    </ul>
                </li>

                <li class="sidebar-title">Blog  &amp; Section</li>

                <li class="sidebar-item  has-sub  @if(\Request::is('admin/blogList'))) active @endif">
                    <a href="#" class='sidebar-link'>
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  @if(\Request::is('admin/blogList'))) active @endif ">
                            <a href="/admin/blogList" class="submenu-link">Blog List</a>
                        </li>
